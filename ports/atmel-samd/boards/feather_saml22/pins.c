...
STATIC const mp_rom_map_elem_t board_global_dict_table[] = {
    ...
    { MP_ROM_QSTR(MP_QSTR_LED_RED), MP_ROM_PTR(&pin_PA04) },
    { MP_ROM_QSTR(MP_QSTR_LED_BLUE), MP_ROM_PTR(&pin_PB22) },
    { MP_ROM_QSTR(MP_QSTR_LED_GREEN), MP_ROM_PTR(&pin_PB23) },

    { MP_ROM_QSTR(MP_QSTR_BUZZER), MP_ROM_PTR(&pin_PA27) },

    { MP_ROM_QSTR(MP_QSTR_BTN_LIGHT), MP_ROM_PTR(&pin_PB05) },
    { MP_ROM_QSTR(MP_QSTR_BTN_MODE), MP_ROM_PTR(&pin_PA07) },
    { MP_ROM_QSTR(MP_QSTR_BTN_ALARM), MP_ROM_PTR(&pin_PA02) },

    { MP_ROM_QSTR(MP_QSTR_BTN_VBUS_DET), MP_ROM_PTR(&pin_PA03) },
